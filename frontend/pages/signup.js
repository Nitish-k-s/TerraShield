// Signup Page – Paper-Cut Landscape Theme
export function renderSignup() {
  ...
  <div style="min-height:100vh;display:flex;flex-direction:column;position:relative;overflow:hidden;background:linear-gradient(180deg,#e0f2f1 0%,#e8f5f3 30%,#f0f8f6 60%,#fdfbf7 100%)">
    ...
    <div style="flex:1;display:flex;flex-direction:column;align-items:center;position:relative;z-index:10;padding:var(--space-8) var(--space-4);overflow-y:auto">
      ...
      <!-- Card -->
      <div class="hero-animate-delay" style="width:100%;max-width:26rem;background:rgba(255,255,255,0.75);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border-radius:var(--radius-xl);box-shadow:0 8px 32px rgba(0,0,0,0.08);border:1px solid rgba(255,255,255,0.6);padding:var(--space-8) var(--space-8);flex-shrink:0">
        <form onsubmit="event.preventDefault(); window.location.hash='#/';" style="display:flex;flex-direction:column;gap:var(--space-5)">
          <div class="form-group">
            <label class="form-label">Full Name</label>
            <div class="form-input-icon">
              <span class="material-symbols-outlined">person</span>
              <input class="form-input" type="text" placeholder="Jane Doe" required style="background:rgba(255,255,255,0.6)">
            </div>
          </div>
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--space-4)">
            <div class="form-group">
              ...
              <div class="form-input-icon">
                ...
                <input class="form-input" type="password" placeholder="••••••••" required style="background:rgba(255,255,255,0.6)">
              </div>
            </div>
            <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select class="form-input" style="background:rgba(255,255,255,0.6)">
          ...
          <button type="submit" class="btn btn-primary" style="width:100%;padding:var(--space-3) var(--space-4)">
            <span class="material-symbols-outlined" style="font-size:1.125rem">person_add</span> Create Account
          </button>
