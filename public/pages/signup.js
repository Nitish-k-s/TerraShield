// Signup Page – Dark Forest Theme + Real Supabase Auth
    ...
    <div style="position:absolute;inset:0;pointer-events:none;z-index:0">
      ...
      <div style="position:absolute;top:2rem;left:12%;z-index:1">
        <svg width="90" height="90" viewBox="0 0 140 140">
          <circle cx="70" cy="70" r="30" fill="rgba(220,240,220,0.12)" opacity="0.8"/>
      ...
      <!-- Birds -->
      <svg style="position:absolute;top:6%;left:25%;z-index:6;opacity:0.4;animation:bird-fly 18s ease-in-out infinite" width="55" height="20" viewBox="0 0 50 20">
        <path d="M0,10 Q12,0 25,10 Q38,0 50,10" fill="none" stroke="rgba(74,222,128,0.3)" stroke-width="2.5" stroke-linecap="round"><animate attributeName="d" values="M0,10 Q12,0 25,10 Q38,0 50,10;M0,10 Q12,6 25,10 Q38,6 50,10;M0,10 Q12,0 25,10 Q38,0 50,10" dur="0.5s" repeatCount="indefinite"/></path>
      </svg>
      <svg style="position:absolute;top:3%;left:55%;z-index:6;opacity:0.3;animation:bird-fly 22s ease-in-out 3s infinite" width="45" height="17" viewBox="0 0 50 20">
        <path d="M0,10 Q12,0 25,10 Q38,0 50,10" fill="none" stroke="rgba(74,222,128,0.25)" stroke-width="2.5" stroke-linecap="round"><animate attributeName="d" values="M0,10 Q12,0 25,10 Q38,0 50,10;M0,10 Q12,6 25,10 Q38,6 50,10;M0,10 Q12,0 25,10 Q38,0 50,10" dur="0.55s" repeatCount="indefinite"/></path>
      </svg>

      <!-- Fireflies -->
      <div style="position:absolute;top:18%;left:30%;width:4px;height:4px;background:#4ade80;border-radius:50%;filter:blur(2px);animation:firefly-float 6s ease-in-out infinite;opacity:0.5"></div>
      <div style="position:absolute;top:25%;right:25%;width:3px;height:3px;background:#4ade80;border-radius:50%;filter:blur(2px);animation:firefly-float 8s ease-in-out 2s infinite;opacity:0.4"></div>
      <div style="position:absolute;top:12%;left:60%;width:3px;height:3px;background:#22c55e;border-radius:50%;filter:blur(1px);animation:firefly-float 7s ease-in-out 4s infinite;opacity:0.3"></div>
    ...
    <div style="flex:1;display:flex;flex-direction:column;align-items:center;position:relative;z-index:10;padding:var(--space-8) var(--space-4);overflow-y:auto">
      ...
      <a href="#/" class="hero-animate" style="display:flex;align-items:center;gap:var(--space-3);margin-bottom:var(--space-6);text-decoration:none;flex-shrink:0">
        <svg class="ts-logo" width="36" height="36" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
          <defs><linearGradient id="shield-grad-signup" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#4ade80"/><stop offset="100%" stop-color="#22c55e"/></linearGradient></defs>
      ...
      <div class="hero-animate" style="text-align:center;margin-bottom:var(--space-6);flex-shrink:0">
        <h1 class="font-serif" style="font-size:clamp(1.5rem,4vw,2.25rem);font-weight:var(--fw-bold);color:#f0f8f0;margin-bottom:var(--space-2);text-shadow:0 2px 10px rgba(0,0,0,0.3)">Join the Detection Network</h1>
        <p style="color:var(--color-slate-600);font-size:0.875rem">Create your account to start reporting invasive species.</p>
      </div>

      <!-- Card -->
      <div class="hero-animate-delay" style="width:100%;max-width:26rem;background:rgba(15,35,20,0.85);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border-radius:var(--radius-xl);box-shadow:0 8px 40px rgba(0,0,0,0.5),0 0 80px rgba(74,222,128,0.04);border:1px solid rgba(74,222,128,0.15);padding:var(--space-8);flex-shrink:0;position:relative;overflow:hidden">
        ...
        <form id="signup-form" style="display:flex;flex-direction:column;gap:var(--space-5)">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--space-4)">
            <div class="form-group">
              ...
              <div class="form-input-icon">
                ...
                <input class="form-input" id="signup-password" type="password" placeholder="••••••••" required minlength="6" style="background:rgba(10,25,15,0.6)">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="form-input-icon">
                ...
                <input class="form-input" id="signup-confirm" type="password" placeholder="••••••••" required minlength="6" style="background:rgba(10,25,15,0.6)">
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <select class="form-input" id="signup-role" style="background:rgba(10,25,15,0.6)">
          ...
          <div class="form-checkbox">
            ...
            <label for="terms" style="font-size:0.8125rem;color:var(--color-slate-600)">I agree to the <a href="#" style="color:var(--color-primary);font-weight:var(--fw-bold)">Terms</a> and <a href="#" style="color:var(--color-primary);font-weight:var(--fw-bold)">Privacy Policy</a></label>
          </div>
      ...
      <div class="hero-animate-delay-2" style="display:flex;justify-content:center;gap:var(--space-8);margin-top:var(--space-6);flex-shrink:0">
        <span style="display:flex;align-items:center;gap:var(--space-2);font-size:0.65rem;font-weight:var(--fw-bold);text-transform:uppercase;letter-spacing:0.08em;color:var(--color-slate-500)">
    ...
    async init() {
      ...
      if (c) {
        ...
        for (let i = 0; i < 10; i++) {
          ...
          p.style.cssText = 'position:absolute;font-size:' + (7 + Math.random() * 7) + 'px;opacity:0.08;animation:particle-float ' + (6 + Math.random() * 6) + 's ease-in-out ' + (Math.random() * 4) + 's infinite;left:' + (Math.random() * 100) + '%;top:' + (Math.random() * 55) + '%;pointer-events:none';
          c.appendChild(p);
        }
      }
